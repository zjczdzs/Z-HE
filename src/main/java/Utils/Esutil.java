...
public class Esutil {
    ...
    public static String addIndex(String index, String type, Info info){
        HashMap<String, Object> hashMap = new HashMap<String, Object>();
        hashMap.put("id", info.getId());
        hashMap.put("title",info.getTitle());
        hashMap.put("describe", info.getDescribe());
        hashMap.put("author", info.getAuthor());
    ...
    public static Map<String, Object> search(String key, String index, String type, int start, int row){
        ...
        builder.setSize(row);
        //设置高亮字段名称
        builder.addFetchField("title");
        builder.addFetchField("describe");
        //设置高亮前缀
        builder.addFetchField("<font color='red' >");
        //设置高亮后缀
        builder.addFetchField("</font>");
